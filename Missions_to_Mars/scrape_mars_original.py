###  NOTE--> THIS PROGRAM IS DEPRECATED, NEW VERSION CONSISTS OF A SCRAPE FUNCTION CALLABLE 
#            FROM APP.PY AND ALL MONGO PROCESSING IS DONE THERE.  THIS IS TO ACCOMIDATE GRADING
#            RUBRIC LOOKING FOR A CALLED SCRAPE FUNCTION RATHER THAN A SEPERATE PROGRAM LOADING
